...
def train(name:str):
    ...
    path = '/home/cavin/jiangtao/spatial_data/stDCL/DLPFC/'
    ...
    sc.pl.spatial(adata, color=["ground_truth", "domain"], title=['ground truth', 'BayesSpace (ARI=%.2f)' % ARI_score],show=False)
