...
import sys
sys.path.append('/home/guo/jt/python/wave/time_no_dic/_stagate')
import pandas as pd
import numpy as np
import scanpy as sc
...
def loading_and_preprocess_data():
    ...
    adata = sc.read_h5ad('/home/guo/jt/data/Embryo/E16.5_E1S3_deleted_info.MOSTA.h5ad')
    # adata = adata[:5000]
...
def clustering(adata):
    # 聚类的数量，使用mclust
    num_cluster = len(adata.obs['annotation'].unique())
